...
<body>
    ...
    <header>
        {{-- <a href='/home' class="btn btn-default"> Back To Homepage</a> --}}
        <a class="btn btn-delete" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">LOGOUT</a>
    ...
    <div class="box">
        ...
        <div class="details">
            <ul>
                <h2>{{$post->title}}</h2> 
                <li>Content: <strong>{{$post->content}}</strong></li>
                <li>Created date: <strong>{{$post->created_at}}</strong></li>
                <li>Last updated date: <strong>{{$post->updated_at}}</strong></li>
